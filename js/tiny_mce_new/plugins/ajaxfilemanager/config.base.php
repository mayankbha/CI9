...
//error_reporting(E_ALL ^ E_NOTICE);
        ...
        define('CONFIG_SYS_DEFAULT_PATH', '../../../upload_tiny_mce/'); //accept relative path only
        define('CONFIG_SYS_ROOT_PATH', '../../../upload_tiny_mce/');        //accept relative path only
        ...
        define("CONFIG_SYS_DIR_SESSION_PATH", '../../../upload_tiny_mce/');
        ...
        define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,ppt,doc,pdf'); //
        ...
        define('CONFIG_WEBSITE_DOCUMENT_ROOT', $_SERVER['DOCUMENT_ROOT'].'/dev/jonathank');
