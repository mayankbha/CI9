...
<table style="width: 100%; margin-bottom: 50px">
  <tr>
    ...
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-large-green.png" alt=""></div>
    <div class="step-text-table"><div class="step-text">Overall A</div></div>
    <div class="clear"></div>
    </div>
    </td>
    <td class="hidden-phone col-2-percent"><img src="<?=base_url();?>images/front/todo-col-devider.gif" alt=""></td>
    <td class="col-30-percent"><div class="step-box small-round">
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-av-size1.png" alt=""></div>
    ...
    <td class="hidden-phone col-2-percent"><img src="<?=base_url();?>images/front/todo-col-devider.gif" alt=""></td>
    <td class="col-30-percent"><div class="step-box small-round">
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-av-size2.png" alt=""></div>
    <div class="step-text-table"><div class="step-text"><span>Sub 2</span>Lorem Ipsum</div></div>
    <span class="step-mask"></span>
    <div class="clear"></div>
    </div></td>
  </tr>
   ...
   <td class="col-30-percent"><div class="step-box large-round">
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-av-size1.png" alt=""></div>
    <div class="step-text-table"><div class="step-text"><span>Lesson</span>Lorem Ipsum</div></div>
    <span class="step-mask"></span>
    <div class="clear"></div>
    </div></td>
    <td class="hidden-phone col-2-percent"><img src="<?=base_url();?>images/front/todo-col-devider.gif" alt=""></td>
    <td class="col-30-percent"><div class="step-box large-round">
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-av-size2.png" alt=""></div>
    <div class="step-text-table"><div class="step-text"><span>Lesson 1</span>Lorem Ipsum</div></div>
    <span class="step-mask"></span>
    <div class="clear"></div>
    </div></td>
       <td class="hidden-phone col-2-percent"><img src="<?=base_url();?>images/front/todo-col-devider.gif" alt=""></td>
    <td class="col-30-percent"><div class="step-box large-round">
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-av-size3.png" alt=""></div>
   <div class="step-text-table"><div class="step-text"><span>Survey</span>Lorem Ipsum </div></div>
    <span class="step-mask"></span>
    <div class="clear"></div>
    </div></td>
  </tr>
  ...
  <tr>
   <td class="col-30-percent"><div class="step-box small-round">
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-large-gray.png" alt=""></div>
    ...
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-large-orange.png" alt=""></div>
    <div class="step-text-table"><div class="step-text">Overall D<span class="progres-bar"><img src="<?=base_url();?>images/front/progress-bar.gif" alt=""></span></div></div>
...
<tr>
   <td class="col-30-percent"><div class="step-box small-round green-step">
    <div class="pull-left"><img src="<?=base_url();?>images/front/todo-small-green.png" alt=""></div>
    <div class="step-text-table"><div class="step-text"><span>Sub 1</span>Lorem Ipsum</div></div>
    <div class="clear"></div>
    </div></td>
    <td class="hidden-phone col-2-percent"><img src="<?=base_url();?>images/front/todo-col-devider.gif" alt=""></td>
...
<div class="down-arrow text-center"><a href="#"><img src="<?=base_url();?>images/front/down-arrow.gif" width="52" height="30" alt=""></a></div>
