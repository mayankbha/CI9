...
<div id="popover-wrapper">
  ...
  <div id="popover">
    ...
    <div id="popover-body">
      ...
      <div class="text-center row-fluid" style="padding-top: 20px;"><img src="<?=base_url();?>images/front/removed-cat.png" alt=""></div>

      <div class="signup-confirmmsg" style="width:410px; padding-left:65px;" align="center"><?=str_replace('<p>','',str_replace('</p>','',$content));?></div>

      <div class="text-center"><a href="#" class="btn-link">Confirm</a> <a href="#" class="btn-link">Cancel</a></div>
