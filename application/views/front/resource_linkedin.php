...
<div class="span3"><img src="<?php  echo base_url();?>images/front/popup-logo.png" alt=" "></div>
...
<a href="#" class="pull-right"><img src="<?php  echo base_url();?>images/front/linkin_pp.jpg" alt="fb"></a>
...
<img src="<?php  echo base_url();?>images/front/image_pp.jpg" alt="image" class="img_brdr pull-left">
...
<div class="submit-form">
  <input name="" type="button" class="custom-btn" value="Share" onClick="closePP(); openForm('<?php  echo site_url('blog/linkedin_confirmation');?>');">
