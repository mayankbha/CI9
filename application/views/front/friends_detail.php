...
<?php if(!$is_friend): ?>
<a href="<?php echo site_url('friends/add/')."/".$member->member_id ?>"><img src="<?php echo  base_url();?>images/front/atf_btn.png" alt="add to friend"></a>
<?php else: ?>
<a href="<?php echo site_url('friends/delete/')."/".$member->member_id ?>"><img src="<?php echo  base_url();?>images/front/unfollow.png" alt="Unfollow"></a>
<?php endif; ?>
</div>
