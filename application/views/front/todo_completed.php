...
<div id="popover-wrapper">
  ...
  <div id="popover">
    ...
    <div id="popover-body">
      ...
      <div class="text-center row-fluid" style="padding-top: 20px;"><img src="<?=base_url();?>images/front/happy-face.png" alt=""></div>

      <div class="signup-confirmmsg" style="width:362px; padding-left:90px;" align="center"><?=str_replace('<p>','',str_replace('</p>','',$content));?></div>
