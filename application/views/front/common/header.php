<div class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-inner">
		...
		<div class="container">
			...
			<a class="brand" href="<?php echo base_url();?>"><img src="<?php  echo base_url();?>/images/front/logo.png" alt="Meow Startup"></a>
			...
			<div class="nav-collapse collapse">
				...
				<div id="logged-info" class="logged-out clearfix">
					...
					<div id="social-media">
						...
						<a href="#"><img src="<?php  echo base_url();?>/images/front/facebook.png" alt="facebook" title="facebook"></a>

						<a href="#"><img src="<?php  echo base_url();?>/images/front/twitter.png" alt="twitter" title="twitter"></a>
				...
				<ul class="nav clear">
					...
					<li class="active"><a href="<?php echo site_url('myaccount');?>">My Account</a></li>

					<li class=""><a href="#">Reading</a></li>

					<li class=""><a href="<?php echo site_url('resource');?>" >Resources</a></li>

					<li class=""><a href="<?php echo site_url('friends');?>">Friends</a></li>
			...
			<div class="nav-collapse collapse">
				<div id="logged-info" class="clearfix">
					...
					<form method="post" id="loginForm" class="ajax_form login_form validate_form" data-validate="parsley" data-focus="first" data-error-container="ul#formerrors" action="<?php echo site_url('login/process'); ?>"/>
						<div id="error"></div>
						<div class="user-field">

							<a href="<?php echo site_url('login');?>"><strong>Login</strong></a>
							<input type="hidden" name="decode" value="<?php echo isset($confirm)?$confirm:'';?>" />
					...
					<div id="social-media">
						...
						<a href="#" class="help-ico"><img src="<?php  echo base_url();?>/images/front/help-icon.png" alt="Help" title="Help"></a>
