...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link rel="shortcut icon" href="<?php  echo base_url();?>images/favicon.ico?id=2" type="image/x-icon"/>

		<link rel="icon" href="<?php  echo base_url();?>images/favicon.ico?id=2" type="image/x-icon"/>
	...
	<body>
		...
		<div id="wrapper" <?php  echo ($sel=='home') ? 'style="background-image:none;"' : '';?>   >
