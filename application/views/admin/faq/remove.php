<link href="<?php echo base_url();?>css/admin/popup.css" rel="stylesheet" type="text/css" />
  ...
  <div id="sm_pp">
    <div id="pp_header">
      <div class="alignleft">Remove Help</div>
    ...
    <div id="pp_contents">
      <div class="pp_msg" align="center">Are you sure you want to delete this?<span>This action is NOT reversible</span></div>
      <div align="center">
        <input name="" type="button" class="btn" onclick="closePP();" value="Cancel" style="margin-right:7px" />
        <input name="" type="button" onclick="window.location='<?=site_url('admin/faq/delete/'.$faq_id);?>'" class="btn" value="Confirm" />
      </div>
    </div>
