...
<div class="ymp_content form_div form_blog_edit">
	<form class="form-horizontal" action="<?php echo site_url('admin/survey/add'); ?>" method="post" enctype="multipart/form-data">
		<div class="control-group">
			<label class="control-label" for="inputTitle">Title:</label>
			<div class="controls">
				<input type="text" name="title" id="inputTitle" class="span7 input_field" placeholder="">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputAuthor">Author:</label>
			<div class="controls">
				<input type="text" name="author" id="inputAuthor" class="span7 input_field" placeholder="">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">Category:</label>
			<div class="controls">
				<?php categoryDropdown(0,'category_id','input_field span7',false); ?>
			</div>
		</div>
		<div class="control-group date_input">
			<label class="control-label" for="inputDate">Date:</label>
			<div class="controls">
				<input type="text" id="inputDate" name="date" class="span3 input_field datepicker" value="<?php echo date('d-m-Y'); ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputEmbed">Embed Link:</label>
			<div class="controls">
				<input type="text" id="inputEmbed" name="embed_link" class="span7 input_field" placeholder="">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="inputMeta" name="meta_tags" class="span7 input_field" placeholder="">
			</div>
		</div>
		<div class="control-group">
