                        ...
                        <li class="<?php if (isset($sel) && ($sel == 'learning' OR $sel == 'resource' OR $sel === 'lessons')) echo 'active'; ?> dropdown"><a href="#"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li <?php if (isset($sub_sel) && $sub_sel == 'lesson_categories') echo 'class="active"';?>>
                                    <a href="<?php echo (isset($sub_sel) && $sub_sel == 'lesson_categories') ? "javascript:void()" : site_url('admin/lesson_categories'); ?>">Lessons
                                        Categories Controller</a></li>
                                <li class=""><a href="<?php echo base_url('admin/recommendations') ?>">Recommendation Controller</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
