...
<a href="<?php echo site_url('admin/lessons/add/'); ?>" class="ymp_top_btn pull-right">Create New Recommendation</a>
<div class="clear"></div>
<div class="tabular_cont">
    ...
    <?php  
	 ...
	 foreach($recommendation->result() as $recommen) { ?>
    <tr>
        <td><a href="<?php echo site_url('admin/lessons/view/'.$recommen->r_id); ?>"  style="color:black"><?php  echo $recommen->title;  ?></a></td>
        <td class="hidden-phone hidden-tablet"><a href="<?php echo site_url('admin/lessons/view/' .$recommen->r_id); ?>" style="color:black"><?php  echo $recommen->stage;  ?></a></td>
        <td class="hidden-phone hidden-tablet"><a href="<?php echo site_url('admin/lessons/view/' .$recommen->r_id); ?>" style="color:black"><?php  echo $recommen->overall;  ?></a></td>
        <td class="hidden-phone"><a href="<?php echo site_url('admin/lessons/view/' .$recommen->r_id); ?>"  style="color:black"><?php  echo $recommen->sub1;  ?></a></td>
        <td class="hidden-phone"><a href="<?php echo site_url('admin/lessons/view/' .$recommen->r_id); ?>"  style="color:black"><?php  echo $recommen->sub2;  ?></a></td>
        <td class="action"><a href="<?php echo site_url('admin/lessons/edit/' .$recommen->r_id); ?>"><img src="<?php echo base_url()?>images/edit_icon.png" alt=" "></a> 
                                                ...
                                                <div class="popover-content">
                                                    <p> Are you sure you want to do this?
                                                        <span>This action is NOT reversible. </span> <span
                                                            class="sp_btn">
										<button type="button"
                                                data-target-url="<?php echo site_url('admin/lessons/delete/' . $recommen->r_id); ?>"
