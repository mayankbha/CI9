...
<a href="#" class="ymp_top_btn pull-right">Export Users</a>
<div class="clear"></div>
<div class="tabular_cont popup_table">
	<table>
		<thead>
			<tr>
				<th class=""><a href="<?php echo site_url('admin/members/search/'.$search_keyword."/" . $page . '/first_name/' . ($orderBy == "first_name" ? ($order == "asc" ? "desc" : "asc") : "asc")); ?>" class="">First Name <?php echo($orderBy == "first_name" ? "<i class=\"sorting-" . $order . "\"></i>" : ""); ?></a> </th>
				<th class=""><a href="<?php echo site_url('admin/members/search/'.$search_keyword."/" . $page . '/last_name/' . ($orderBy == "last_name" ? ($order == "asc" ? "desc" : "asc") : "asc")); ?>" class="<?php echo($orderBy == "last_name" ? $order : ""); ?>">Last Name <?php echo($orderBy == "last_name" ? "<i class=\"sorting-" . $order . "\"></i>" : ""); ?></a></th>
				<th class="hidden-phone"><a href="<?php echo site_url('admin/members/search/'.$search_keyword."/" . $page . '/email/' . ($orderBy == "email" ? ($order == "asc" ? "desc" : "asc") : "asc")); ?>" class="<?php echo($orderBy == "email" ? $order : ""); ?>">Email <?php echo($orderBy == "email" ? "<i class=\"sorting-" . $order . "\"></i>" : ""); ?></a></th>
				<th class="hidden-phone"><a href="<?php echo site_url('admin/members/search/'.$search_keyword."/" . $page . '/created/' . ($orderBy == "created" ? ($order == "asc" ? "desc" : "asc") : "asc")); ?>" class="<?php echo($orderBy == "created" ? $order : ""); ?>">Date Registered <?php echo($orderBy == "created" ? "<i class=\"sorting-" . $order . "\"></i>" : ""); ?></a></th>
				<th>Actions</th>
			</tr>
		</thead>
		<tbody>
