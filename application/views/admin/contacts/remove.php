...
<div id="popover">
  <div id="sm_pp">
    <div id="pp_header">
      <div class="alignleft">Remove Contact</div>
    ...
    <div id="pp_contents">
      <div class="pp_msg" align="center">Are you sure you want to delete this Contact?<span>This action is NOT reversible</span></div>
      <div align="center">
        <input name="" type="button" class="btn" onclick="closePP();" value="Cancel" style="margin-right:7px" />
        <input name="" type="button" class="btn" onclick="window.location='<?=site_url('admin/contacts/delete/'.$contact_id);?>'" value="Confirm" />
      </div>
    </div>
