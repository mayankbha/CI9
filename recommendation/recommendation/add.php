...
<div class="controls">
<input name="title" type="text" class="input_field" value="">
</div>
</div>
...
<div class="controls">
<input type="text" name="image" class="input_field" value="" style="vertical-align:middle;width:67%">
...
<div class="controls">
<input name="affiliate_link" type="text" class="input_field" value="">
</div>
</div>
</div>
...
<option value="<?php echo $lc->id ?>"><?php echo $lc->stage ?></option>
<?php endforeach; ?>
<?php endif; ?>
</select>
</div>
...
<?php if($lcs): ?>
<?php foreach($lcs as $lc): ?>
<option value="<?php echo $lc->id ?>"><?php echo $lc->overall ?></option>
<?php endforeach; ?>
<?php endif; ?>
</select>
</div>
...
<?php if($lcs): ?>
<?php foreach($lcs as $lc): ?>
<option value="<?php echo $lc->id ?>"><?php echo $lc->sub1 ?></option>
<?php endforeach; ?>
<?php endif; ?>
</select>
</div>
...
<?php if($lcs): ?>
<?php foreach($lcs as $lc): ?>
<option value="<?php echo $lc->id ?>"><?php echo $lc->sub2 ?></option>
<?php endforeach; ?>
<?php endif; ?>
</select>
</div>
